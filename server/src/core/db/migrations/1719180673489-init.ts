...
export class Init1719180673489 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."booking_status_enum" AS ENUM('0', '1', '2', '3', '4', '5')`);
        await queryRunner.query(`CREATE TYPE "public"."booking_paymentmode_enum" AS ENUM('0', '1')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_usertype_enum" AS ENUM('0', '1', '2')`);
