...
compAttrs.config = {
  ...compAttrs.config,
  prevArrow:
    '<i class="solar:alt-arrow-left-outline" style="font-size: 20px; height: 20px; width: 20px;"></i>',
  nextArrow:
    '<i class="solar:alt-arrow-right-outline" style="font-size: 20px; height: 20px; width: 20px;"></i>'
}
